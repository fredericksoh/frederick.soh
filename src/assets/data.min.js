...
const data = {
	...
	Home: {
		introduction: " from Saint Joseph's University Philadelphia,PA",
	...
	Training: {
		...
		training: [
			[{
				...
				description:"This credential validates both core Tableau knowledge and hands-on development skills of users who need to work with various Tableau products including:Tableau Desktop,Tableau Prep, and either Tableau Server or Tableau Online.",
